...
To that end, we note that the distribution of $\hat{\theta}_{MOM}$ converges to the normal distribution with mean $E_{\hat{\theta}_{MOM}} (X) = \theta$ and variance $Var(\hat{\theta}_{MOM}) = \frac{\theta^2} {3n}$ (noting our prior work in parts 1 and 2 (B), resp.). 
