...
(3): $\frac{\partial{Q}}{\partial{\beta_0}} = -2\sum \limits_{i=1}^{n} \left( y_i - \beta_0 - \beta_1x_i \right) $

Eq. (11.1.4): 

(4): $\frac{\partial{Q}}{\partial{\beta_1}} = -2\sum \limits_{i=1}^{n} \left( y_i - \beta_0 - \beta_1x_i \right) x_i$
